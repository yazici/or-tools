...
def create_data_model():
    ...
    data['vehicle_loading_time'] = 2
    data['vehicle_unloading_time'] = 2
    return data
    # [END data_model]
    ...
    for i in range(data['num_vehicles']):
        ...
        intervals.append(
            solver.FixedDurationIntervalVar(
                ...
                data['vehicle_loading_time'], 'depot_loading_interval'))
        # Add time windows at end of routes.
        intervals.append(
            solver.FixedDurationIntervalVar(
                time_dimension.CumulVar(routing.End(i)),
                data['vehicle_unloading_time'], 'depot_unloading_interval '))
    # Each vehicle consume one slot when loading or unloading.
